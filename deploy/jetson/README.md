...
schema v10과 두 policy 공유 CUDA IPC를 지원하는
`xycar/ai-drive:jp6.2.1-pytorch25.06-schema10-traffic-actions3-v11` tag다. 기본 nice_adaptive artifact는
...
schema v10 artifact가 container 시작 직후 종료될 수 있다.
...
grep -Fx 'GPU_IMAGE=xycar/ai-drive:jp6.2.1-pytorch25.06-schema10-traffic-actions3-v11' \
  /home/xytron/.local/lib/xycar-ai-gpu/images.lock.env
docker image inspect xycar/ai-drive:jp6.2.1-pytorch25.06-schema10-traffic-actions3-v11 >/dev/null
```
...
schema v10은 사람 보정 YOLO11s의 640 letterbox 결과에서 confidence `0.25` 이상
