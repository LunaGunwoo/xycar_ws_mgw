        ...
        [
            DeclareLaunchArgument(
                ...
                default_value=os.path.join(
                    package_share,
                    'config',
                    'guided_history_collection.yaml',
                ),
            ),
            DeclareLaunchArgument(
                'artifact_root',
            ...
            Node(
                ...
                executable='history_guided_collector',
                name='history_policy',
                namespace='/',
                output='screen',
                parameters=[
                    params_file,
                    {
                        ...
                        'collection_profile_path': ParameterValue(params_file, value_type=str),
                ...
                on_exit=Shutdown(reason='history guided collector exited'),
            ),
        ]
    )
